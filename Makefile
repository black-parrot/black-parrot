...
STALLS=instr load_dep fe_cmd branch_override ret_override ret_mispredict btb_mispredict ovr_mispredict dir_mispredict none_mispredict mul icache dcache long_haz unknown control_haz struct_haz fe_queue_stall fe_wait_stall
