...
# The base command to append the configuration to
cmd_base="make -C bp_top/syn -j ${CORES_PER_JOB} run_psample.${SUFFIX} SUITE=beebs PROG=mergesort COSIM_P=1 NBF_CONFIG_P=1 CHECKPOINT_P=1 SAMPLE_INSTR_P=100000"
