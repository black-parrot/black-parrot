...
`define BP_COMMON_AVIARY_PKGDEF_SVH
 ...
 localparam bp_proc_param_s bp_multicore_4_acc_scratchpad_override_p =
  ...
  typedef enum bit [lg_max_cfgs-1:0]
  {
    ...
    e_bp_multicore_16_cce_hybrid_cfg                = 40
    ,e_bp_multicore_12_cce_hybrid_cfg               = 39
    ,e_bp_multicore_8_cce_hybrid_cfg                = 38
    ,e_bp_multicore_6_cce_hybrid_cfg                = 37
    ,e_bp_multicore_4_cce_hybrid_cfg                = 36
    ,e_bp_multicore_3_cce_hybrid_cfg                = 35
