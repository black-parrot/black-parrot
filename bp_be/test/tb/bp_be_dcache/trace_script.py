...
def main():
  ...
  for i in range(8, 72, 8):
    file.write(tracer.send_store(8, i-8, 0, False, i, 0))
  ...
  for i in range(8, 72, 8):
    file.write(tracer.send_load(True, 8, i-8, 0, False, 0))
  ...
  file.write(tracer.send_store(8, 320, 0, True, 320, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.print_comment("Load from address 320 in uncached mode"))
  file.write(tracer.send_load(True, 8, 320, 0, True, 0))
  ...
  file.write(tracer.send_store(8, 0, 0, False, 64, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_store(8, 0, 1, False, 128, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_store(8, 0, 2, False, 256, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_store(8, 64, 3, False, 512, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_store(8, 64, 3, False, 1024, 0))
  file.write(tracer.send_store(8, 0, 1, False, 2048, 0))
  file.write(tracer.send_load(False, 8, 0, 0, False, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.recv_data(0))
  file.write(tracer.recv_data(64))
  file.write(tracer.send_load(False, 8, 0, 1, False, 0))
  ...
  file.write(tracer.send_store(8, 0, 0, False, 64, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_store(8, 0, 0, False, 128, 0))
  file.write(tracer.send_load(False, 8, 64, 0, False, 0))
  file.write(tracer.send_store(8, 0, 0, False, 256, 0))
  file.write(tracer.send_load(False, 8, 128, 0, False, 0))
  file.write(tracer.send_store(8, 0, 0, False, 512, 0))
  file.write(tracer.send_load(False, 8, 192, 0, False, 0))
  file.write(tracer.send_store(8, 0, 0, False, 1024, 0))
  file.write(tracer.send_load(False, 8, 256, 0, False, 0))
  ...
  file.write(tracer.send_store(1, 0, 0, False, 152, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_load(False, 1, 0, 0, False, 0))
  file.write(tracer.recv_data(152))
  file.write(tracer.print_comment("Store byte to address - 73"))
  file.write(tracer.send_store(1, 73, 0, False, 152, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_load(False, 1, 73, 0, False, 0))
  file.write(tracer.recv_data(152))
  file.write(tracer.print_comment("Store byte to address - 146"))
  file.write(tracer.send_store(1, 146, 0, False, 152, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_load(False, 1, 146, 0, False, 0))
  file.write(tracer.recv_data(152))
  file.write(tracer.print_comment("Store byte to address - 219"))
  file.write(tracer.send_store(1, 219, 0, False, 152, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_load(False, 1, 219, 0, False, 0))
  file.write(tracer.recv_data(152))
  file.write(tracer.print_comment("Store byte to address - 292"))
  file.write(tracer.send_store(1, 292, 0, False, 152, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_load(False, 1, 292, 0, False, 0))
  file.write(tracer.recv_data(152))
  file.write(tracer.print_comment("Store byte to address - 365"))
  file.write(tracer.send_store(1, 365, 0, False, 152, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_load(False, 1, 365, 0, False, 0))
  file.write(tracer.recv_data(152))
  file.write(tracer.print_comment("Store byte to address - 438"))
  file.write(tracer.send_store(1, 438, 0, False, 152, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_load(False, 1, 438, 0, False, 0))
  file.write(tracer.recv_data(152))
  file.write(tracer.print_comment("Store byte to address - 511"))
  file.write(tracer.send_store(1, 511, 0, False, 152, 0))
  file.write(tracer.recv_data(0))
  file.write(tracer.send_load(False, 1, 511, 0, False, 0))
  file.write(tracer.recv_data(152))
