...
def main():
  ...
  file.write(tracer.print_comment("Wait for SYNC"))
  file.write(tracer.wait(65))
  file.write(tracer.print_comment("Store to address - 7"))
  file.write(tracer.send_store(8, 7, 0, False, 1030))
  file.write(tracer.recv_data(0))
  file.write(tracer.print_comment("Load byte from address - 0"))
  file.write(tracer.send_load(True, 1, 0, 0, False))
  file.write(tracer.recv_data(6))
  file.write(tracer.print_comment("Store to address - 8"))
  file.write(tracer.send_store(8, 8, 0, False, 1010))
  file.write(tracer.recv_data(0))
  file.write(tracer.print_comment("Load from address - 8"))
  file.write(tracer.send_load(True, 8, 8, 0, False))
  file.write(tracer.recv_data(1010))
  file.write(tracer.print_comment("Store to address - 14"))
  file.write(tracer.send_store(8, 14, 0, False, (1 << 50)))
  file.write(tracer.recv_data(0))
  file.write(tracer.print_comment("Load from address - 14"))
  file.write(tracer.send_load(True, 8, 14, 0, False))
  file.write(tracer.recv_data((1<<50)))
  file.write(tracer.print_comment("Load from address - 8"))
  file.write(tracer.send_load(True, 8, 8, 0, False))
  file.write(tracer.recv_data(1010))
