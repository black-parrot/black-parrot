...
module bp_be_dcache
 ...
 #(parameter bp_params_e bp_params_p = e_bp_inv_cfg
  ...
  wire load_miss_tv = ~load_hit_tv_r & v_tv_r & load_op_tv_r & ~uncached_tv_r & ~amo_req;
  wire store_miss_tv = ~store_hit_tv_r & v_tv_r & store_op_tv_r & ~uncached_tv_r & ~sc_op_tv_r & ~amo_req;
  wire lr_miss_tv = v_tv_r & lr_op_tv_r & ~store_hit_tv_r & (l2_atomic_p == 0);
  ...
  assign lr_hit_tv = v_tv_r & lr_op_tv_r & store_hit_tv_r & (l2_atomic_p == 0);
  ...
  if (l1_writethrough_p == 0) begin : wb_wbuf
    assign wbuf_v_li = v_tv_r & store_op_tv_r & store_hit_tv_r & ~sc_fail & ~uncached_tv_r & ~amo_req;
  end
  else begin : wt_wbuf
    assign wbuf_v_li = v_tv_r & store_op_tv_r & store_hit_tv_r & ~sc_fail & ~uncached_tv_r & ~amo_req & cache_req_ready_i;
  end
